...
movies_data = pd.read_csv(r'C:\Users\shaik\Downloads\movies.csv')  //Replace with your csv path
...
def recommend():
    ...
    if not find_close_match:
        return render_template('recommendation.html', movie_name=movie_name, recommendations=[])
